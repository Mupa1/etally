...
const defaultConfigurations = [
  ...
  },
  {
    ...
    name: 'Africa\'s Talking Sender ID',
  ...
  },
  {
    ...
    name: 'Africa\'s Talking Masked Number',
  ...
  },
  {
    ...
    name: 'Africa\'s Talking Base URL',
    description: 'Base URL for Africa\'s Talking API',
    value: 'https://api.africastalking.com',
    type: ConfigurationType.string,
    category: 'sms',
    isRequired: false,
    isDefault: true,
  },
  {
    ...
    name: 'Africa\'s Talking Bulk Endpoint',
    description: 'Bulk messaging endpoint path for Africa\'s Talking API',
    value: '/version1/messaging/bulk',
    type: ConfigurationType.string,
    category: 'sms',
    isRequired: false,
    isDefault: true,
